...
#             self.dynamic_array = trj.groupby(other_i).progress_apply(trj_to_vertices_single_frame)
...
#Carol: I modiefied a bit this function in order to preserve the information from each spin. Here, in order to compute the #magnitudes Dipole X and Dipole Y, the code performs a sum over all the spin directions, hence the single sipin information is #lost. I added the P1, P2, P3 and P4 that stays for the direction of the spins of particles from 1 to 4.
    ...
    def further_vertex_classification(self):
        ...
        minElement = np.amin(self.spins['Center'][0])
        print(v['id'])
        print(minElement)

        v['P1'] = self.spins[n]['Direction']
        v['P2'] = self.spins[n]['Direction']
        v['P3'] = self.spins[n]['Direction']
        v['P4'] = self.spins[n]['Direction']
                
#                 print(type(self.spins[n]['Center']))
                
                # Carol: Here I saved the spin coordinates 
#                 if i == 0:
#                     a1 = self.spins[n]['Center'][0]
#                     a2 = self.spins[n]['Center'][1]
#                 elif i == 1:
#                     b1 = self.spins[n]['Center'][0]
#                     b2 = self.spins[n]['Center'][1]
#                 elif i == 2:
#                     c1 = self.spins[n]['Center'][0]
#                     c2 = self.spins[n]['Center'][1]
#                 else:
#                     d1 = self.spins[n]['Center'][0]
#                     d2 = self.spins[n]['Center'][1]
                    
# #                 i = i+1
# #                 print(i)  
            
#             for n in self.neighbors[v['id']]:
#                 if len(self.neighbors[v['id']]) <= 3:
#                        x = [a1,b1,c1]
#                        y = [a2,b2,c2]
